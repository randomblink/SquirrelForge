# SquirrelForge Agent Instructions

This repository is governed by the SquirrelForge Agent system.

Before project-changing work, read and follow [`AI-BOOTSTRAP.md`](AI-BOOTSTRAP.md). Existing SquirrelForge managers are authoritative for routing, planning, execution, validation, documentation, and release review.
