...
This directory holds the governed rules and models used to produce and evaluate SquirrelForge artifacts.

## Contents

- `SF-SPEC-*`: normative engineering specifications.
- `SF-METHODOLOGY-*`: practitioner-facing methods derived from demonstrated work.
- `SF-TEMPLATE-*`: governed artifact structures.
- `SF-TAXONOMY-*`: evidence-backed WordPress error-category ownership maps.
