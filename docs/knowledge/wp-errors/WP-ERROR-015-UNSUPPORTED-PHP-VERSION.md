...
- A plugin or theme activation blocked by a `Requires PHP` mismatch notice — see [WP-ERROR-031](WP-ERROR-031-PLUGIN-ACTIVATION-FAILURE.md) for the plugin-activation-specific diagnostic entry point, or [WP-ERROR-039](WP-ERROR-039-THEME-ACTIVATION-FAILURE.md) for the theme-switching-specific diagnostic entry point.
