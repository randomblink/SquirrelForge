...
| Performance | 2 (`WP-ERROR-033`, `034`) | No — category in progress, `WP-ERROR-035` still planned | `SF-TAXONOMY-006` | — |

30 entries, 9 categories, 7 Baseline Certified, across the 14-specification framework at `SF-BASELINE-001`.
...
No category will be considered active again until the remaining Performance entry (`WP-ERROR-035`) is authored and this category proceeds through consistency review and baseline certification.
